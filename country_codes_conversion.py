...
COUNTRY_CODES_2 = [
    ("IE","Ireland"), #This is so it will be coded before GB
    ("AD","Andorra"),
    ...
    ("PN","Pitcairn"),
    ("PR","Puerto Rico"),
    ("PS","Palestine, State of, Palestinian Territory, occupied, "),
    ("PT","Portugal"),
    ("PW","Palau"),
    ("PY","Paraguay"),
    ("QA","Qatar"),
    ...
    ("ZM","Zambia"),
    ("ZW","Zimbabwe"),
    ("XK", "Kosovo"), #https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2 look for 'XK' in text
]
